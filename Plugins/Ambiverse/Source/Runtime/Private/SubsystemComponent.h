...
#include "SubsystemComponent.generated.h"

class UAmbiverseSubsystem;

UCLASS(Abstract, Transient, Within = "AmbiverseSubsystem", ClassGroup = "Ambiverse")
class AMBIVERSE_API USubsystemComponent : public UObject, public FTickableGameObject
{
	GENERATED_BODY()
