...
public:
	 ...
	 */
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "DraggableObject", Meta = (DisplayName = "Begin Drag"))
	 ...
	 */
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "DraggableObject", Meta = (DisplayName = "End Drag"))
