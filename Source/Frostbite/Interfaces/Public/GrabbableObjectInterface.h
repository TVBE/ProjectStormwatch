...
public:
	 ...
	 */
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "GrabbableObject", Meta = (DisplayName = "Begin Grab"))
	 ...
	 */
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "GrabbableObject", Meta = (DisplayName = "End Grab"))
	bool EndGrab(const AActor* Interactor);
	
	/** Returns the interaction hand type of the object. */
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "GrabbableObject", Meta = (DisplayName = "Get Grab Type"))
