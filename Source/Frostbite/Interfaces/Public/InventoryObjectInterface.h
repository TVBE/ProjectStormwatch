...
public:
	 ...
	 */
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "InventoryObject", Meta = (Displayname = "Can Be Added To Inventory"))
	 ...
	 */
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "InventoryObject", Meta = (Displayname = "Add To Inventory"))
	 ...
	 */
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "InventoryObject", Meta = (Displayname = "Remove From Inventory"))
	bool TakeFromInventory(const AActor* Actor);

	/** Returns the inventory trigger type of the object. */
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "InventoryObject", Meta = (Displayname = "Get Inventory Trigger Type"))
