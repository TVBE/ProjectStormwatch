...
class FROSTBITE_API UUsableObject : public UInterface
{
	GENERATED_BODY()
};

class FROSTBITE_API IUsableObject
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "UsableObject", Meta = (DisplayName = "Begin Use"))
	 ...
	 *	@Return Whether the object implements an interaction.
	 */
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "UsableObject", Meta = (DisplayName = "End Use"))
	...
	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "UsableObject", Meta = (DisplayName = "Get Use Type"))
