...
#include "Components/SceneComponent.h"
#include "Reacoustic/ReacousticSoundDataAsset.h"
#include "Reacoustic/ReacousticSoundDataRef_Map.h"
...
void UReacousticSubsystem::PostInitProperties()
{
	...
	{
		UE_LOG(LogReacousticSubsystem, Error, TEXT("Failed to instance data assets."))
	}
