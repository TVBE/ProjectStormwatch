...
#include "BHInventoryComponent.h"
...
bool UBHInventoryComponent::AddToInventory_Implementation(const AActor* Actor)
{
...
bool UBHInventoryComponent::TakeFromInventory_Implementation(const AActor* Actor)
{
	if (!Actor) { return false;}
