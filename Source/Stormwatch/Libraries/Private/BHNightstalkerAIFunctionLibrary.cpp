...
bool UBHNightstalkerAIFunctionLibrary::IsOccluded(UObject* WorldContextObject, const FVector& Origin,
...
bool UBHNightstalkerAIFunctionLibrary::IsOccludedFast(UObject* WorldContextObject, const FVector& LocationA,
...
float UBHNightstalkerAIFunctionLibrary::GetViewAngle(const FRotator& Rotation, const FVector& Origin, const FVector& Target, bool IgnorePitch)
{
