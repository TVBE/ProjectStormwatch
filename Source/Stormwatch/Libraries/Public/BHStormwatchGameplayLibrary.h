...
#include "BHActorFunctionCaller.h"
#include "Kismet/BlueprintFunctionLibrary.h"
#include "BHStormwatchGameplayLibrary.generated.h"
...
UCLASS()
class STORMWATCH_API UBHStormwatchGameplayLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "Stormwatch", Meta = (DisplayName = "Get Player Character",
	...
	UFUNCTION(BlueprintPure, Category = "Stormwatch", Meta = (DisplayName = "Get Player Controller",
		CompactNodeTitle = "Player Controller", Keywords = "Get, Stormwatch, Player, Character, Controller",
		WorldContext = "WorldContextObject"))
	static ABHPlayerCharacterController* GetStormwatchPlayerCharacterController(const UObject* WorldContextObject);
	
	UFUNCTION(BlueprintPure, Category = "Stormwatch", Meta = (DisplayName = "Get Nightstalker", CompactNodeTitle = "Nightstalker",
		Keywords = "Get, Stormwatch, Nightstalker",
		WorldContext = "WorldContextObject"))
	static ABHNightstalker* GetStormwatchNightstalker(const UObject* WorldContextObject);
};
