...
void UBHPlayerInteractionComponent::UpdateInteractableObjectData(AActor* NewInteractableActor)
{
	...
	AddInteractableObjectsOfType<UUsableObject>(NewInteractableActor, EBHInteractionType::Usable);
	AddInteractableObjectsOfType<UGrabbableObject>(NewInteractableActor, EBHInteractionType::Grabbable);
	AddInteractableObjectsOfType<UDraggableObject>(NewInteractableActor, EBHInteractionType::Draggable);
}
