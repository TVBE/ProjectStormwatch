...
UCLASS(Blueprintable, BlueprintType, ClassGroup = "PlayerCharacter",
	...
	class STORMWATCH_API UPlayerCameraController : public UActorComponent
{
	GENERATED_BODY()
...
private:
	...
	UPROPERTY(BlueprintReadOnly, Category = "Animation",
			  Meta = (DisplayName = "Lock Camera To Animation", AllowPrivateAccess = "true"))
...
class STORMWATCH_API UPlayerCameraConfiguration : public UDataAsset
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(BlueprintReadOnly, EditAnywhere, Category = "Camera Sway|Socket",
			  Meta = (DisplayName = "Socket Rotation Contribution While Upright",
	...
	UPROPERTY(BlueprintReadOnly, EditAnywhere, Category = "Camera Sway|Socket",
			  Meta = (DisplayName = "Socket Rotation Contribution While Crouched",
					  ClampMin = "0.0", ClampMax = "2.0", UIMin = "0.0", UIMax = "2.0", EditCondition = "IsCameraSwayEnabled"))
