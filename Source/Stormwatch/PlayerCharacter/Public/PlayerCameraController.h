...
private:
	...
	void UpdateCameraRotation(const float DeltaTime);
	...
	UPROPERTY(EditDefaultsOnly, Category = "Field Of View",
			  Meta = (DisplayName = "Sprint Field Of View", ClampMin = "60.0", ClampMax = "120.0", UIMin = "60.0", UIMax = "120.0", EditCondition = "bDynamicFOVEnabled"))
	...
	UPROPERTY(EditDefaultsOnly, Category = "Depth Of Field",
			  Meta = (DisplayName = "Minimum Focal Distance", ClampMin = "0", ClampMax = "50000", UIMin = "0", UIMax = "50000", EditCondition = "bDynamicDOFEnabled"))
	...
	UPROPERTY(EditDefaultsOnly, Category = "Depth Of Field",
			  Meta = (DisplayName = "Maximum Focal Distance", ClampMin = "0", ClampMax = "50000", UIMin = "0", UIMax = "50000",
					  EditCondition = "bDynamicDOFEnabled"))
	int MaximumFocalDistance = 10000;

	/** The depth blur Focus at the smallest focal distance. */
	UPROPERTY(EditDefaultsOnly, Category = "Depth Of Field",
			  Meta = (DisplayName = "Macro Blur Focus", ClampMin = "0.0", ClampMax = "1.0", UIMin = "0.0", UIMax = "1.0", EditCondition = "bDynamicDOFEnabled"))
	float MacroBlurFocus = 0.05;

	/** The depth blur focus at the largest focal distance. */
	UPROPERTY(EditDefaultsOnly, Category = "Depth Of Field",
			  Meta = (DisplayName = "Long Shot Blur Focus", ClampMin = "0.0", ClampMax = "1.0", UIMin = "0.0", UIMax = "1.0", EditCondition = "bDynamicDOFEnabled"))
	float LongShotBlurFocus = 0.365;

	/** The depth blur Amount at the smallest focal distance. */
	UPROPERTY(EditDefaultsOnly, Category = "Depth Of Field",
			  Meta = (DisplayName = "Macro Blur Intensity", ClampMin = "0.0", ClampMax = "4.0", UIMin = "0.0", UIMax = "4.0", EditCondition = "bDynamicDOFEnabled"))
	float MacroBlurAmount = 1.4;

	/** The depth blur Amount at the largest focal distance. */
	UPROPERTY(EditDefaultsOnly, Category = "Depth Of Field",
			  Meta = (DisplayName = "Long Shot Blur Intensity", ClampMin = "0.0", ClampMax = "4.0", UIMin = "0.0", UIMax = "4.0", EditCondition = "bDynamicDOFEnabled"))
	float LongShotBlurAmount = 1.1;

	/** The interpolation speed for the dynamic depth of field algorithm*/
	UPROPERTY(EditDefaultsOnly, Category = "Depth Of Field",
			  Meta = (DisplayName = "Dynamic Depth Of Field Speed", ClampMin = "0.0", ClampMax = "10.0", UIMin = "0.0", UIMax = "10.0", EditCondition = "bDynamicDOFEnabled"))
	...
	UPROPERTY(EditDefaultsOnly, Category = "Vignette",
			  Meta = (DisplayName = "Sprint Vignette", ClampMin = "0.0", CLampMax = "1.0", UIMin = "0.0", UIMax = "1.0", EditCondition = "bDynamicVignetteEnabled"))
	...
	UPROPERTY(EditDefaultsOnly, Category = "Camera Sway",
			  Meta = (DisplayName = "Camera Sway Intensity", ClampMin = "0.0", ClampMax = "1.0", UIMin = "0.0", UIMax = "1.0", EditCondition = "bCameraSwayEnabled"))
	...
	UPROPERTY(EditDefaultsOnly, Category = "Camera Sway|Socket",
			  Meta = (DisplayName = "Socket Rotation Contribution While Upright", ClampMin = "0.0", ClampMax = "2.0", UIMin = "0.0", UIMax = "2.0", EditCondition = "bCameraSwayEnabled"))
	...
	UPROPERTY(EditDefaultsOnly, Category = "Camera Sway|Socket",
			  Meta = (DisplayName = "Socket Rotation Contribution While Crouched", ClampMin = "0.0", ClampMax = "2.0", UIMin = "0.0", UIMax = "2.0", EditCondition = "bCameraSwayEnabled"))
	...
	UPROPERTY(EditDefaultsOnly, Category = "Centripetal Rotation",
			  Meta = (DisplayName = "Max Centripetal Rotation Angle", ClampMin = "0.0", ClampMax = "45.0", UIMin = "0.0", UIMax = "45.0",
					  EditCondition = "bCentripetalRotationEnabled"))
	...
	UPROPERTY(EditDefaultsOnly, Category = "Centripetal Rotation",
			  Meta = (DisplayName = "Centripetal Rotation Intensity", ClampMin = "0.0", ClampMax = "4.0", UIMin = "0.0", UIMax = "4.0", EditCondition = "bCentripetalRotationEnabled"))
	float CentripetalRotationIntensity = 2.f;

	/** Multiplier for the centripetal rotation caused by lateral velocity of the player. */
	UPROPERTY(EditDefaultsOnly, Category = "Centripetal Rotation",
			  Meta = (DisplayName = "Velocity Based Centripetal Rotation", ClampMin = "0.0", ClampMax = "4.0", UIMin = "0.0", UIMax = "4.0", EditCondition = "bCentripetalRotationEnabled"))
	float VelocityCentripetalRotation = 1.f;

	/** Multiplier for the centripetal rotation caused by rotation of the player. */
	UPROPERTY(EditDefaultsOnly, Category = "Centripetal Rotation",
			  Meta = (DisplayName = "Rotation Based Centripetal Rotation", ClampMin = "0.0", ClampMax = "4.0", UIMin = "0.0", UIMax = "4.0", EditCondition = "bCentripetalRotationEnabled"))
	float RotationCentripetalRotation = 2.f;

	/** When enabled, centripetal rotation will also be applied when not sprinting. */
	UPROPERTY(EditDefaultsOnly, Category = "Centripetal Rotation",
			  Meta = (DisplayName = "Sprint Only", EditCondition = "bCentripetalRotationEnabled"))
	bool bCentripetalRotationSprintOnly = true;

	/** Multiplier for the centripetal rotation when not sprinting. */
	UPROPERTY(EditDefaultsOnly, Category = "Centripetal Rotation",
			  Meta = (DisplayName = "Sprint Multiplier", EditCondition = "bCentripetalRotationEnabled"))
